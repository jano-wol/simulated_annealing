...
IPosition::CPtr SalesmanAngleGenerator::getStartPosition(int idx) const
{
  Random r(idx);
  ...
  return std::make_unique<SalesmanAnglePosition>(cities);
}

IPosition::CPtr SalesmanAngleGenerator::getStartPosition_5x5(int idx) const
{
  Random r(idx);
...
IPosition::CPtr SalesmanAngleGenerator::generatePosition(int idx) const
{
  if (subSquares) {
...
std::string SalesmanAngleGenerator::getGeneratorName() const
{
  std::stringstream ss;
